          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-100 leading-relaxed mb-8">
                With Biddulphs you don't simply move your office, you relocate
                with a minimum of disruption. Complete planning and execution
                for seamless business moves.
              </p>
              <Link
                to="/get-quote"
            ...
            {[
              {
                ...
                title: "Office Moves",
                desc: "Complete office relocation services",
              },
              {
                icon: <Users size={32} />,
                title: "Planning Support",
                desc: "Dedicated project management",
              },
              {
                icon: <Clock size={32} />,
                title: "Minimal Downtime",
                desc: "After-hours & weekend options",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 text-lg mb-8">
                We understand that time is money. Our expert team ensures your
                business transition happens smoothly with minimal disruption to
                your operations.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Detailed timeline and logistics",
                  },
                  {
                    icon: <Briefcase size={24} />,
                    title: "Professional Execution",
                    desc: "Trained corporate moving specialists",
                  },
                  {
                    icon: <Shield size={24} />,
                    title: "Asset Protection",
                    desc: "Secure handling of equipment",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex items-start space-x-4 p-4 bg-white rounded-xl shadow-lg hover:shadow-sm transition-shadow"
                  >
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            From small offices to large corporate headquarters, we handle every
            detail
          </p>
            ...
            {[
              {
                ...
                desc: "Specialized tech equipment handling",
              },
              {
                img: "/30.jpg",
                title: "Furniture Systems",
                desc: "Modular office furniture setup",
              },
              {
                img: "/28.jpg",
                title: "Archive Management",
                desc: "Secure document handling",
              },
              {
                img: "/27.jpg",
                title: "Space Planning",
                desc: "Layout and design coordination",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-display font-bold text-center mb-12">
              Why Choose Biddulphs for Business Moves
            </h2>
              ...
              {[
                {
                  step: "01",
                  title: "Consultation",
                  desc: "Initial site survey and planning",
                },
                {
                  step: "02",
                  title: "Planning",
                ...
                },
                {
                  step: "03",
                  title: "Execution",
                  desc: "Professional moving team",
                },
                {
                  step: "04",
                  title: "Setup",
                  desc: "Complete installation and support",
                },
              ].map((phase, i) => (
                <motion.div
                  key={i}
