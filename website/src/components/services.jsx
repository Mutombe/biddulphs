...
import { 
  Truck, Globe, Users, Package, Shield, FileText, 
  ArrowRight, CheckCircle, TrendingDown
} from 'lucide-react';
  ...
  const services = [
    {
      icon: <Truck size={48} />,
      title: 'Local Moves',
      description: 'Whether it is a small flat or major household, this will be the best move you\'ll ever make. Professional, efficient, and stress-free local moving services.',
      path: '/services/local-moves',
      gradient: 'from-blue-500 to-blue-600',
      features: ['Same-day service', 'Professional packing', 'Furniture protection', 'Affordable rates'],
      tags: ['Residential', 'Commercial', 'Same Day']
    },
    {
      icon: <Globe size={48} />,
      title: 'International Moves',
      description: 'Our international consultants are expertly versed in all aspects of overseas moving. From customs clearance to door-to-door delivery.',
      path: '/services/international-moves',
      gradient: 'from-green-500 to-green-600',
      features: ['FIDI certified', 'Customs handling', 'Door-to-door', 'Insurance included'],
      tags: ['Worldwide', 'FIDI', 'Shipping']
    },
    {
      icon: <Users size={48} />,
      title: 'Business Relocation',
      description: 'With Biddulphs you don\'t simply move your office, you relocate with a minimum of disruption. Complete office moving solutions.',
      path: '/services/business-moves',
      gradient: 'from-purple-500 to-purple-600',
      features: ['Planning assistance', 'Minimal downtime', 'IT equipment care', 'Furniture installation'],
      tags: ['Corporate', 'Planning', 'Weekend Moves']
    },
    {
      icon: <Shield size={48} />,
      title: 'Storage Facilities',
      description: 'Modern palletized storage and self storage facilities keep your belongings safe & secure. Short-term and long-term options available.',
    ...
    },
    {
      ...
      description: 'Professional packing services using high-quality materials to ensure your items are protected during transit. Expert packing crews available.',
      path: '/services/packing',
      gradient: 'from-yellow-500 to-yellow-600',
      features: ['Quality materials', 'Expert packers', 'Fragile item care', 'Unpacking service'],
      tags: ['Professional', 'Materials', 'Protection']
    },
    {
      icon: <FileText size={48} />,
      title: 'Transit Insurance',
      description: 'Comprehensive insurance coverage for your peace of mind. All-risk, door-to-door coverage with competitive rates.',
      path: '/services/insurance',
      gradient: 'from-indigo-500 to-indigo-600',
      features: ['All-risk coverage', 'Competitive rates', 'Easy claims', 'Full protection'],
      tags: ['Coverage', 'Peace of Mind', 'Claims Support']
    },
    {
      icon: <Truck size={48} />,
      title: 'Biddulphs Freight',
      description: 'Professional logistic services for freight distribution, customized to your requirements and operating needs across Zimbabwe and SADC.',
      path: '/services/freight',
      gradient: 'from-orange-500 to-orange-600',
      features: ['Overnight delivery', 'Satellite tracking', 'SADC coverage', 'Load consolidation'],
        ...
        <div className="relative container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-200 leading-relaxed mb-8">
              Comprehensive moving and logistics solutions tailored to meet your unique needs
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              <Chip label="Established 1928" sx={{ bgcolor: '#EEC643', color: '#040F0F', fontWeight: 600, fontFamily: 'Gellix' }} />
              <Chip label="150+ Years Experience" sx={{ bgcolor: '#EEC643', color: '#040F0F', fontWeight: 600, fontFamily: 'Gellix' }} />
              <Chip label="2.5M+ Moves" sx={{ bgcolor: '#EEC643', color: '#040F0F', fontWeight: 600, fontFamily: 'Gellix' }} />
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                >
                  <div className={`bg-gradient-to-br ${service.gradient} p-8 text-white group-hover:scale-105 transition-transform duration-300`}>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {service.tags.map((tag) => (
                        <Chip 
                          ...
                          size="small" 
                          sx={{ 
                            bgcolor: '#F3F4F6', fontFamily: 'Gellix',
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience the difference of working with Zimbabwe's most trusted moving company
            </p>
          </motion.div>
