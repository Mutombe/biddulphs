            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Biddulphs International has been moving families around the
                  country since 1928. With over 90 years of experience in the
                  moving industry, we have established ourselves as Zimbabwe's
                  most trusted moving and logistics company.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Starting as a small family business, we have grown to become a
                  leading provider of comprehensive moving solutions, serving
                  thousands of families and businesses across Zimbabwe and the
                  SADC region.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Today, with three strategic depots in Harare, Bulawayo, and
                  Gweru, we continue to deliver exceptional service with the
                  same commitment to excellence that has defined us for nearly a
                  century.
                </p>
              </motion.div>
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-primary-dark/80 to-transparent">
                    <p className="text-white font-semibold text-lg">
                      Nearly a century of trusted service
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              FIDI Certified Excellence
            </h2>
            <p className="text-xl text-gray-200 mb-6 max-w-2xl mx-auto">
              Biddulphs International moving partners comply with strict
              international FIDI FAIM quality standards, ensuring the highest
              level of service for your international moves.
            </p>
            <Chip
              label="FIDI FAIM Certified"
              sx={{
                bgcolor: "#EEC643",
                color: "#040F0F",
                fontWeight: 600,
