        ...
        <div className="relative container-custom text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
              Frequently Asked{" "}
              <span className="text-accent-gold">Questions</span>
            </h1>
                ...
                >
                  ...
                  {category !== "All" && (
                    <span className="ml-1 text-xs opacity-75">
                      (
                      {
                        faqs.find((f) => f.category === category)?.questions
                          .length
                      }
                      )
                    </span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <h3 className="font-semibold text-primary-dark flex-1">
                        {faq.q}
                      </h3>
                    </div>
                    <AnimatePresence>
        ...
        <div className="container-custom text-center relative">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Our friendly team is here to help. Contact us and we'll get back
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              >
                ...
                <div className="text-sm text-gray-200">
                  Offices in Harare, Bulawayo, Gweru
                </div>
              </motion.div>
            </div>
          </motion.div>
